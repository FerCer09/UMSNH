            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <nav>
                        <ul>
                            <?php  
                            echo "<a href='categorias.php?id_cliente=". $id_cliente ."'>Salir</a>"
                            ?>
                       <!-- <a href="http://192.168.0.5/administrador/categorias.php">    Salir</a>     -->
                        </ul>
                    </nav>
                    <?php
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                //                 echo "<a href='delete.php?id_producto=". $row['id_producto'] ."' title='Eliminar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                 echo "<a href='cat_prod.php?id_cliente=". $id_cliente ."&id_cat=". $row['id_categoria'] ."&id=". $row['id'] ."'title='Prod_categorias' class='btn btn-success pull-right'>Ver Productos</a>";
