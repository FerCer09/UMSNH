            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Tus Pedidos</h2>
                    </div>
                    <nav>
                        <ul>
                    ...
                    // Include config file
                    require_once "config.php";
                    $sql = "SELECT c.correo, p.id_producto AS ID, p.titulo,pc.precio AS PRECIO,DATE_FORMAT(pc.fecha,'%h:%i %p of %M %e, %Y') AS FECHA, cantidad FROM pedidos AS pc,clientes AS c, productos as p WHERE pc.id_cliente = c.id AND pc.id_producto = p.id_producto and c.id = $id_cliente";
