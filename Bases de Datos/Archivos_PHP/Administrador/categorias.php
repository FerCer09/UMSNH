        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <nav>
                        <ul>
                        <a href="http://192.168.1.5/administrador/productos.php">    Salir</a>
                        </ul>
                    </nav>
                    <?php
                    // Include config file
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                //                 echo "<a href='delete.php?id_producto=". $row['id_producto'] ."' title='Eliminar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                               echo "<a href='subcategorias.php?id=". $row['id'] ."'title='Subcategorias' class='btn btn-success pull-right'>Subcategorias</a>";
